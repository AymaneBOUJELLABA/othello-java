...
public abstract class GameSearch {
    ...
    public abstract Position [] possibleMoves(Position p, boolean player);    //-- MOUAD
    public abstract Position makeMove(Position p, boolean player, Move move); //-- MOUAD
    public abstract boolean reachedMaxDepth(Position p, int depth);           //-- 
    public abstract Move createMove();                                        //-- MOUAD
